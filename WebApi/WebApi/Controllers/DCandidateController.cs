...
namespace WebApi.Controllers
{
    ...
    public class DCandidateController : ControllerBase
    {
        ...
        // GET: api/DCandidate
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DCandidate>>> GetDCandidtes()
        {
            return await _context.DCandidtes.ToListAsync();
        }
        ...
        {
            var dCandidate = await _context.DCandidtes.FindAsync(id);
        ...
        {
            _context.DCandidtes.Add(dCandidate);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<DCandidate>> DeleteDCandidate(int id)
        {
            ...
            _context.DCandidtes.Remove(dCandidate);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.DCandidtes.Any(e => e.id == id);
        }
    }
}
